...
/* =============================================================================
 * HELPER FUNCTIONS (userspace only)
 * =============================================================================
 */
#ifdef __linux__
#include <stdio.h>
...
static inline const char* cmd_name(uint16_t cmd) {
    switch (cmd) {
        case CMD_PING:      return "PING";
        case CMD_PRINT:     return "PRINT";
        case CMD_RUN_MODEL: return "RUN_MODEL";
        default:            return "UNKNOWN";
    }
}

/* Response status names */
static inline const char* rsp_name(uint16_t status) {
    switch (status) {
        case RSP_OK:    return "OK";
        case RSP_ERROR: return "ERROR";
...
/* Data type names */
static inline const char* dtype_name(uint8_t dtype) {
    switch (dtype) {
...
/* Blob type names */
static inline const char* blob_type_name(uint8_t type) {
    switch (type) {
        case BLOB_TYPE_RAW:       return "RAW";
        case BLOB_TYPE_TENSOR:    return "TENSOR";
        case BLOB_TYPE_MODEL_REF: return "MODEL_REF";
        case BLOB_TYPE_RESULT:    return "RESULT";
        default:                  return "UNKNOWN";
    }
}
